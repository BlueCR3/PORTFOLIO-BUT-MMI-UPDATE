...
const projectsData = {
    fr: [
        ...
        { id:24,  category:'Exprimer',    span:'lg:col-span-1', img:'images2/jv nouveautés (1080 x 1350 px).jpg',   link:'https://www.instagram.com/p/DQcK1JqDlFU/?igsh=dGp2YWtmaWxldDdx',                                                                                                                           title:"Post éditorial J-V – Blo’k Actu",                                                                                desc:"Réalisation d’un post éditorial pour valoriser les sorties jeux vidéo. Recherche de titres, sélection d’extraits et respect de la ligne éditoriale du média." },  
    ],
    en: [
        ...
        { id:23,  category:'Concevoir',    span:'lg:col-span-1', img:'images2/MINIATURE.png',                       link:'https://youtube.com/shorts/_V1Oz8q3NeA',                                                                                                                                                   title:"Video Carousel: Present but Absent",                                                                          desc:"A video carousel exploring the paradox of constant connectivity and social isolation. This project visually examines our ability to remain truly grounded in the present moment. A creation that demonstrates my sensitivity to capturing complex contemporary issues." },
        { id:24,  category:'Exprimer',    span:'lg:col-span-1', img:'images2/jv nouveautés (1080 x 1350 px).jpg',   link:'https://www.instagram.com/p/DQcK1JqDlFU/?igsh=dGp2YWtmaWxldDdx',                                                                                                                           title:"Gaming Editorial Post – Blo’k Actu",                                                                           desc:"Creation of an editorial post to highlight new video game releases. Includes title research, selection of excerpts, and adherence to the media's editorial line." },  
    ],
    ]
};
